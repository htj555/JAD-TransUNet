...
FOLDER = "/home/htj107552403789/寒假突击/4、FTransUNet-1.1 - 副本+数据增强+编码器浅层特征融合2/dataset/" # Replace with your "/path/to/the/ISPRS/dataset/folder/"
...
def metrics(predictions, gts, label_values=LABELS):
    ...
    valid = (gts >= 0) & (gts < len(label_values))
